...
As a final review before you dive into the in-person course, let's take some
time to revisit one of the most challenging labs we've completed: Hashketball.

Solving Hashketball requires a good understanding of how to work with collection
data types. These are skills that will be useful not just in writing Ruby, but
JavaScript, and pretty much any other languages you might pursue in the future.

This lab is a clone of Hashketball, but includes a full video review of the lab.
If you have not completed the lab yet, we strongly recommend you work to solve it
on your own before checking out the video.

If you _have_ completed the lab, use this as an opportunity to review. There are
many possible solutions - revisit your own solution and compare it to the one
discussed in the video.

## Video: Hashketball Review

<iframe width="560" height="315" src="https://www.youtube.com/embed/Nvrvp-oxRws" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

# Hashketball Revisited

## Instructions

Welcome to Hashketball revisited. In this lab, you will be implementing
methods to work with a nested data structure. You've already built the structure
in a previous lab, so we've provided it for you in this lab.
